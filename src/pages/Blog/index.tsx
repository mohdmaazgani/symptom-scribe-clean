    ...
    <div className="min-h-screen bg-[#0a0f1a] text-gray-200">
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 leading-tight">Our Blog</h1>
          <p className="text-gray-500 text-lg max-w-xl leading-relaxed">
            Science-backed insights, practical tips, and expert guidance to help you understand and
            improve your health.
          </p>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-wrap items-center gap-3 mb-3">
                  <span
                    className={`px-3 py-0.5 rounded-full border ${color.border} ${color.bg} ${color.text} text-xs font-medium flex items-center gap-1.5`}
                  >
