...
import { ShieldAlert, Plus, Trash2, BarChart2 } from "lucide-react";
    ...
    <div className="container mx-auto px-4 py-8 space-y-8 animate-fade-in">
      <div className="border-b pb-6">
        <h1 className="text-3xl font-bold tracking-tight text-foreground flex items-center gap-2">
          ...
          {t("sidebar.items.emergencyContacts", "Emergency Contacts")}
        </h1>
        <p className="text-muted-foreground mt-1">Store and manage emergency medical contacts including physicians, pharmacists, and family members.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Record your emergency contacts data</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <label className="text-xs font-semibold text-muted-foreground uppercase block">Contact Name & Role</label>
                <Input
              ...
              >
                <Plus className="h-4 w-4 mr-1" /> Save Contact
              </Button>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          <ContactSummary entries={hook.entries} />
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                <CardTitle className="text-lg flex items-center gap-2">
                  <BarChart2 className="h-5 w-5" /> Contact Directory
                </CardTitle>
