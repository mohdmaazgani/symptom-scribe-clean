    ...
    <LegalPageLayout title="Accessibility" icon={Accessibility}>
      ...
      <div role="note" className="rounded-xl bg-primary/5 border border-primary/20 p-5">
        <p className="text-foreground text-sm leading-relaxed">
          <strong>Our Commitment:</strong> Symptom Scribe is committed to ensuring digital
          accessibility for people with disabilities. We continually improve the user experience for
      ...
      <Section title="1. Our Standard">
        <p>
          ...
          disabilities, covering visual, auditory, physical, speech, cognitive, and neurological
          conditions.
        </p>
      </Section>
      ...
      <Section title="3. Known Limitations">
        <p>
          While we strive for full accessibility, some areas of the platform may not yet fully meet
          all WCAG 2.1 AA criteria. We are actively working to address these gaps. Known areas under
          improvement include:
        </p>
        <ul className="mt-3 space-y-2">
          {[
      ...
      <Section title="4. Assistive Technology Support">
        <p>
          Symptom Scribe is designed to be compatible with commonly used assistive technologies,
          including:
        </p>
        <ul className="mt-3 space-y-2">
          {[
      ...
      <Section title="5. Feedback & Support">
        <p>
          We welcome feedback on the accessibility of Symptom Scribe. If you encounter any barriers
      ...
      <Section title="6. Formal Complaints">
        <p>
          ...
          the relevant national or regional disability rights authority in your jurisdiction. We are
          committed to finding a constructive resolution.
        </p>
      </Section>
    </LegalPageLayout>
  );
