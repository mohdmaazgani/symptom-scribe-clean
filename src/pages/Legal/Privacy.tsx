  ...
  return (
    <LegalPageLayout title="Privacy Policy" icon={Shield}>
      <Section title="1. Introduction">
        <p>
          Welcome to <strong className="text-foreground">Symptom Scribe</strong>. We are committed
      ...
      <Section title="4. Sharing of Information">
        <p>
          ...
          information with trusted service providers who assist us in operating the platform,
          subject to confidentiality agreements. We may also disclose information when required by
          law.
        </p>
      </Section>
      ...
      <Section title="5. Data Security">
        <p>
          ...
          regular security audits to protect your data. However, no method of internet transmission
