  ...
  return (
    <LegalPageLayout title="Terms of Service" icon={FileText}>
      <Section title="1. Acceptance of Terms">
        <p>
          By accessing or using <strong className="text-foreground">Symptom Scribe</strong>, you
      ...
      <Section title="2. Description of Service">
        <p>
          Symptom Scribe is a health tracking and wellness platform that helps users monitor health
          goals, analyze symptoms, and receive AI-assisted health insights. The platform is intended
          for informational purposes only and does not constitute medical advice, diagnosis, or
          treatment.
        </p>
      </Section>
      ...
      <Section title="5. Intellectual Property">
        <p>
          All content, features, and functionality of Symptom Scribe — including text, graphics,
          logos, and software — are the exclusive property of Symptom Scribe and are protected by
          intellectual property laws. You may not copy, modify, or distribute any portion without
      ...
      <Section title="6. Disclaimers">
        <p>
          ...
          the service will be uninterrupted, error-free, or free of harmful components. Health
      ...
      <Section title="7. Limitation of Liability">
        <p>
          To the fullest extent permitted by law, Symptom Scribe shall not be liable for any
